...
# Source: https://github.com/niconielsen32/camera-calibration/blob/main/camera_calibration.py
...
CALIBRATION_IMAGES_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'calibration', 'calibration_images', '*.jpg')  # Path to calibration images
OUTPUT_DIRECTORY = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'calibration', 'output')  # Directory to save calibration results
