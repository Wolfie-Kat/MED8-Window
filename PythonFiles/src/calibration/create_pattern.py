...
# Source: https://github.com/opencv/opencv/blob/3.4/doc/pattern_tools/gen_pattern.py
...
example usage: python gen_pattern.py -o checkerboard_pattern/chessboard.svg --rows 9 --columns 6 --type checkerboard --square_size 25
"""
